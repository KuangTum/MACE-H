#!/usr/bin/env python
import os
from maceh import testResultAnalyzer
...
7) Get the sample level std and everything in action 4
...
while True:
    ...
    if option == '0':
        ...
        print('Error mode: (mae/mse/rmse/rae)')
        mode = input()
    ...
    # defined by Chen
        ...
        exclude = input().split()
        kernel = testResultAnalyzer(data_dir, output_dir)
        ret = kernel.std_error_analysis(include, exclude, mode)
